...
urlpatterns = [
    ...
    path('api/users/register/', CreateUserView.as_view(), name='register'),  # Endpoint to create a new user
    ...
    path('api-auth/', include('rest_framework.urls')), # Optional: for browsable API authentication
